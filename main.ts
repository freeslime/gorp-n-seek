...
sprites.onOverlap(SpriteKind.Player, SpriteKind.letter, function (sprite6, otherSprite6) {
    game.showLongText("A letter? In the fridge? LOL", DialogLayout.Bottom)
    game.showLongText("What does it say?", DialogLayout.Bottom)
    levelFive()
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.wood, function (sprite3, otherSprite3) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Button, function (sprite8, otherSprite8) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.rock, function (sprite7, otherSprite7) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.bred, function (sprite2, otherSprite2) {
...
function level_six () {
    ...
    wood2 = sprites.create(img`
        ...
        . . . . . . . . . . . . . . . . 
        `, SpriteKind.wood)
    wood2.setPosition(54, 74)
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.melk, function (sprite4, otherSprite4) {
...
function levelFour () {
    ...
    letter2 = sprites.create(img`
        ...
        ..........................
        `, SpriteKind.letter)
    letter2.setPosition(120, 108)
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.water, function (sprite5, otherSprite5) {
...
let letter2: Sprite = null
let milk: Sprite = null
let rock2: Sprite = null
let brad: Sprite = null
let wood2: Sprite = null
let soap2: Sprite = null
